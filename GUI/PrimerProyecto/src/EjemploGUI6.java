...
public class EjemploGUI6 extends JFrame implements ActionListener {
    ...
    private void initComponents() {
        ...
        String[] botones = { "7", "8", "9", "/","x", "4", "5", "6", "*","x", "1", "2", "3", "-","x", "C", "0", "=", "+", "x" };
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> new EjemploGUI6());
    }
}
